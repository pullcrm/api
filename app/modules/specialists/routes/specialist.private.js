...
router.post('/:id/addTimeOff', auth([SPECIALIST, ADMIN, MANAGER]), SpecialistController.addTimeOff)
router.post('/:id/addTimeWork', auth([SPECIALIST, ADMIN, MANAGER]), SpecialistController.addTimeWork)
router.get('/:id/timeWork', auth([ADMIN, MANAGER, SPECIALIST]), SpecialistController.getTimeWork)
router.put('/:id/timeWork/:timeWorkId', auth([ADMIN, MANAGER, SPECIALIST]), SpecialistController.updateTimeWork)
router.delete('/:id/timeWork/:timeWorkId', auth([ADMIN, MANAGER, SPECIALIST]), SpecialistController.destroyTimeWork)
